...
| `raw_items.source_title` | `ai_journal.source_title` |
| `raw_items.raw_content` | `ai_journal.content` |
...
| `generated_news.title` | `ai_journal_analysis.title`、`t_news_data_info.title` |
| `generated_news.summary` | `ai_journal_analysis.summary`、`t_news_data_info.summary` |
| `generated_news.key_points` | `ai_journal_analysis.key_points`、`t_news_data_info.key_points` |
| `generated_news.content_json` | `ai_journal_analysis.content_json`、`t_news_data_info.content_json` |
